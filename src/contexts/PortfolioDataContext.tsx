  ...
  projects: [
    {
      ...
      highlight:
        "Wallet-first auth and props-filtered views so themes ship without raw transcripts crossing the trust boundary.",
    ...
    },
    {
      ...
      highlight: "Companion to RanneG/linkup_mcp (LlamaIndex + Ollama) for editor-side RAG.",
