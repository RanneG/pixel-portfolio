...
export const WebsiteEatingSnake: React.FC<WebsiteEatingSnakeProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Score Display */}
      <div
        className="fixed top-4 left-1/2 -translate-x-1/2 z-[10001] pixel-border px-4 py-2"
        style={{ 
          pointerEvents: "none",
          backgroundColor: "rgba(8, 8, 16, 0.95)", // Dark card background
          border: "2px solid #00ffff", // Cyan border
          color: "#00ffff", // Cyan text
        }}
      >
        <p className="font-pixel text-xs" style={{ color: "#00ffff", margin: 0 }}>
